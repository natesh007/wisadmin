...
class Admin extends BaseController
{
	...
	public function pagenotfound(){
		if(session()->get('AID') != null) {
			...
			$accessspecifiers = $AccessModel->getaccesspecifiers(); //access specifiers
			$accessarray = array_column($accessspecifiers, 'ModuleName'); //access specifiers
			$headerdata['accessspecifierdata'] = $accessarray ;
			echo view('Modules\Admin\Views\common\header',$headerdata);*/
			echo view('Modules\Admin\Views\common\header');
