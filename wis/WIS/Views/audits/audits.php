...
<?php echo view('Modules\WIS\Views\common/header_sub')  ?>
    <div class="AppFllContainer">
        <div class="ContainerLeft">
            <span class="SctnTtl Adts">Audits</span>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <span class="PgTtl">Completed Audits</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="TableHldr">
                    <table class="AppDataTbl">
                        <tr class="Hdr">
                            ...
                            <th>
                                <span class="DataTtl">Type of Audit</span>
                            </th>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Audit Name</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>/auditObservations" class="DataLnk">View Observations</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url(); ?>/auditRecommendations" class="DataLnk">View Recommendations</a>
                            </td>
                            <td>
