...
<head>
    ...
    <title>Audit Recommendations</title>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <a href="<?php echo base_url(); ?>HospitalAdmin/audits" class="BrdCrmLnk">Completed Audits</a>
                        </li>
                        <li>
                            <span class="PgTtl">Audit Recommendation</span>
                        </li>
                    </ul>
                </div>
            </div>
