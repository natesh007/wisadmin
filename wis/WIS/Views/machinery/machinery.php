        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn CGSSMchnry">CGSS Plant</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn ACPlntMchnry">A/C Plant</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn SbStnMchnry">Sub Station</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn BlrPlntMchnry">Boiler Plant</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn PmpRmMchnry">Pump Room</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt Icn WtrClrMchnry">Water Coolers</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="InnrPgBgHldr">
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn CGSSMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">CGSS Plant</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            ...
                            <div class="MchnryBtns">
                                ...
                                <a href="<?php echo base_url(); ?>/machineryDetails" class="LnkTxt">Details</a>
                            </div>
                        </div>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn ACPlntMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">A/C Plant</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            <span class="MchnryQty">4</span>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn SbStnMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">Sub Station</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            <span class="MchnryQty">4</span>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn BlrPlntMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">Boiler Plant</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            <span class="MchnryQty">4</span>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn PmpRmMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">Pump Room</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            <span class="MchnryQty">4</span>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn WtrClrMchnry">
                        <a href="<?php echo base_url(); ?>/machineryDetails" class="FtrTtl"><span class="LnkTxt">Water Coolers</span></a>
                    </div>
                    <div class="MchnryFleDv">
                        <div class="MchnryFleHldr">
                            <span class="MchnryQty">4</span>
