...
<head>
    ...
    <title>Beds & Occupancy Tower Section Details</title>
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ul class="MenuList">
                            ...
                            <li>
                                <a href="BedsOccupancy.html" class="AppMenuLnk BdsOccpncy Actv">
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="BedsOccupancyDetails.html" class="LnkTxt Icn Twr Actv">Tower 01</a>
                    </li>
                    <li>
                        <a href="BedsOccupancyDetails.html" class="LnkTxt Icn Twr">Tower 02</a>
                    </li>
                    <li>
                        <a href="BedsOccupancyDetails.html" class="LnkTxt Icn Twr">Tower 03</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <a href="BedsOccupancy.html" class="BrdCrmLnk">All Towers</a>
                        </li>
                        <li>
                            <a href="BedsOccupancyDetails.html" class="BrdCrmLnk">Tower 01</a>
                        </li>
                        <li>
                            <span class="PgTtl">Operation Theatre</span>
                        </li>
                    </ul>
                </div>
            </div>
