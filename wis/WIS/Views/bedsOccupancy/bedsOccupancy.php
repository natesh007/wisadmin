        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="<?php echo base_url(); ?>/bedsOccupancyDetails" class="LnkTxt Icn Twr">Tower 01</a>
                    </li>
                    <li>
            ...
            <div class="InnrPgBgHldr">
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/bedsOccupancyDetails" class="FtrTtl"><span class="LnkTxt">Tower 01</span></a>
                    </div>
                    <div class="BdsOccuFleDv">
                        <div class="BdsOccuFleHldr">
                            ...
                            <div class="BdsOccuBtns">
                                ...
                                <a href="<?php echo base_url(); ?>/bedsOccupancyDetails" class="LnkTxt">Details</a>
                            </div>
                        </div>
                        <div class="BdsOccuFleHldr">
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/bedsOccupancyDetails" class="FtrTtl"><span class="LnkTxt">Tower 02</span></a>
                    </div>
                    <div class="BdsOccuFleDv">
                        <div class="BdsOccuFleHldr">
                            <span class="BdsOccuArName">Operations</span>
                ...
                <div class="ChcklstDshbrdHldr">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/bedsOccupancyDetails" class="FtrTtl"><span class="LnkTxt">Tower 03</span></a>
                    </div>
                    <div class="BdsOccuFleDv">
                        <div class="BdsOccuFleHldr">
                            <span class="BdsOccuArName">Operations</span>
