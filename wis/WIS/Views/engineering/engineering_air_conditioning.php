...
<head>
    ...
    <title>Engineering - Air Conditionning</title>
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>/engineeringAirConditioning" class="LnkTxt Icn EnggArCndtng Actv">Air Conditioning</a>
                    </li>
                    <li>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        ...
                        <li>
                            <span class="PgTtl">Air Conditioning</span>
                        </li>
                    </ul>
                </div>
            </div>
