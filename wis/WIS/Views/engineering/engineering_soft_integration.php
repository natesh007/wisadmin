...
<head>
    ...
    <title>Engineering - Soft Integration</title>
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>/engineeringSoftIntegration" class="LnkTxt Icn EnggSftIntrgtn Actv">Soft Integration</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/engineeringSpecializedSolutions" class="LnkTxt Icn EnggSpclSltn">Specialized Solutions</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        ...
                        <li>
                            <span class="PgTtl">Soft Integration</span>
                        </li>
                    </ul>
                </div>
            </div>
