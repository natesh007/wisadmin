...
<script type="text/javascript">
    ...
    const icons = {
        blue: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-BNew-Med.png",
        },
        green: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-GNew-Med.png",
        },
        orange: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-ONew-Med.png",
        },
        blue_sub: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-BAddNew-Med.png",
        },
        green_sub: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-GAddNew-Med.png",
        },
        orange_sub: {
            icon: "<?= base_url() ; ?>/public/wis_assets/Images/AppIcon-MapMarker-OAddNew-Med.png",
        }
