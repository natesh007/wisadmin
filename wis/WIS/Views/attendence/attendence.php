    ...
    <div class="AppFllContainer">
        ...
        <div class="ContainerRight">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6 BttnHldr">
                            <button type="button" onclick="location.href='<?php echo base_url(); ?>/attendenceCustomDate'" class="btn btn-primary SbmtBtn">Submit</button>
            ...
            <div class="InnrPgBgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>/attendenceDeptDetail" class="FtrTtl Icn NursngStff"><span class="LnkTxt">Nursing Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>/attendenceDeptDetail" class="FtrTtl Icn ScrtyStff"><span class="LnkTxt">Security Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>/attendenceDeptDetail" class="FtrTtl Icn EnggStff"><span class="LnkTxt">Engineering Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
                ...
                <div class="PrptyFtrsDshbrd StffAttndDshb">
                    <div class="FtrTtlHldr">
                        <a href="<?php echo base_url(); ?>/attendenceDeptDetail" class="FtrTtl Icn AdmnStff"><span class="LnkTxt">Administrative Staff</span></a>
                    </div>
                    <div class="StffAttndDshbHldr">
                        <div class="StffBscDtls">
                            <div class="StffImgHldr">
