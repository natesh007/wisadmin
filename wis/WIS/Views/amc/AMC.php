                ...
                <div class="TableHldr">
                    <table class="AppDataTbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>/amcObservations" class="DataLnk">View Observations</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url(); ?>/amcRecommendations" class="DataLnk">View Recommendations</a>
                            </td>
                            <td>
