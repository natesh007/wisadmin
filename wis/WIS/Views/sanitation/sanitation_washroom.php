            ...
            <div class="InnrPgBgHldr">
                <div class="ChcklstDshbrdHldr WithSlider">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/sanitationWashroomDetails" class="FtrTtl"><span class="LnkTxt">Tower 01</span></a>
                    </div>
                ...
                <div class="ChcklstDshbrdHldr WithSlider">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/sanitationWashroomDetails" class="FtrTtl"><span class="LnkTxt">Tower 02</span></a>
                    </div>
                    <div class="SantWshrmFleDv">
                        <div class="SantWshrmDashSlider">
                            <div>
                ...
                <div class="ChcklstDshbrdHldr WithSlider">
                    <div class="FtrTtlHldr Icn Twr">
                        <a href="<?php echo base_url(); ?>/sanitationWashroomDetails" class="FtrTtl"><span class="LnkTxt">Tower 03</span></a>
                    </div>
                    <div class="SantWshrmFleDv">
                        <div class="SantWshrmDashSlider">
                            <div>
