    ...
    <div class="AppFllContainer">
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <li>
                        <a href="<?php echo base_url(); ?>/sanitation" class="LnkTxt Wshrm Icn Actv">Washroom</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/sanitationWasteManagement" class="LnkTxt WstMngmnt Icn">Waste Management</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>/sanitationPestControl" class="LnkTxt PstCntrl Icn">Pest Control</a>
                    </li>
                    <li>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>/sanitation" class="BrdCrmLnk">Washroom</a>
                        </li>
                        <li>
                            ...
                            <div class="SnglWshrmDashSlider">
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #101 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #102 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #103 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #104 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #105 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #106 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                        ...
                        <div class="WsrmFllDtls">
                            <div class="SnglWshrmDashSlider">
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #201 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #202 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl ">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #203 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #204 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #205 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #206 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                        ...
                        <div class="WsrmFllDtls">
                            <div class="SnglWshrmDashSlider">
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #301 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #302 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #303 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #304 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #305 (Male)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl">
                                ...
                                <div>
                                    <div class="SnglWshDtl">
                                        <div class="WshrmTtlHldr">
                                            <a href="<?php echo base_url(); ?>/sanitationWashroomFullDetails" class="WshrmFlrTtl">Washroom #306 (Female)</a>
                                        </div>
                                        <ul class="FllLst">
                                            <li class="Fll">
                                                <div class="WshrmDtlsTxtHldr Ico Schdl MnlAlrt">
