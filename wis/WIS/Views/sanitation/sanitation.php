...
<head>
    <meta http-equiv="refresh" content="0;URL='<?php echo base_url(); ?>HospitalAdmin/sanitation_Washroom'" />
    <meta charset="UTF-8" />
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                <ul class="InnrLnksHldr">
                    <li>
                        <a href="Sanitation-Washroom.html" class="LnkTxt Wshrm Icn">Washroom</a>
                    </li>
                    <li>
                        <a href="Sanitation-WasteManagement.html" class="LnkTxt WstMngmnt Icn">Waste Management</a>
                    </li>
                    <li>
                        <a href="Sanitation-PestControl.html" class="LnkTxt PstCntrl Icn">Pest Control</a>
                    </li>
                    <li>
                        <a href="Sanitation-FacadeCleaning.html" class="LnkTxt FcdeClnng Icn">Facade Cleaning</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        <li>
                            <span class="PgTtl">All Sanitation</span>
                        </li>
                    </ul>
                </div>
            </div>
