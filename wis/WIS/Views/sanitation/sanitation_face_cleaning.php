...
<head>
    ...
    <title>Sanitation - Facade Cleaning</title>
        ...
        <div class="ContainerLeft">
            ...
            <div class="SctnInnerLnks">
                ...
                <li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>/sanitationFaceCleaning" class="LnkTxt FcdeClnng Icn Actv">Facade Cleaning</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="SctnDtlsTtlHldr">
                <div class="BrcmnbHldr">
                    <ul class="DtlsBrdCrmb">
                        ...
                        <li>
                            <span class="PgTtl">Facade Cleaning</span>
                        </li>
                    </ul>
                </div>
            </div>
