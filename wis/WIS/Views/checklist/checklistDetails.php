    ...
    <div class="AppFllContainer">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Common Area Meter Reading</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">DG Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Diesel Consumption</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Elevator Weekly</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">HT Meter</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">UPS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">CCTV Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">CCTV Monthly</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">FAS Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Alarm Control Panel</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Alarm Report</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Alarm System</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">PA System</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Extinguisher Service Report</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Extinguisher Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Extinguisher Weekly</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Fighting Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire Hydrant Box</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Fire System Testing</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Sprinkler Main Tap Off Valve</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Chiller Log Book</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">AC Unit</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">AHU</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Daily Exhaust System</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Daily Fresh Air Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Daily Jet Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Spilt A/C</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Ventilation Fan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Ventilation</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Daily Plumbing Leakage B4 Shaft</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Pump Room  JWC</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">RO Plant Log Book</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Sump Pump</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Water Consumption Log</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Water Pump Daily</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Water Softner Log</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Water Tank Level Status</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url(); ?>/checklistDetails" class="SbLnk">Water Treatment Plant Log</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="ContainerRight">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-5 BttnHldr">
                            <button type="button" onclick="location.href='<?php echo base_url(); ?>/checklistSubDetails'" class="btn btn-primary SbmtBtn">Submit</button>
            ...
            <div class="InnrPgBgHldr">
                <span class="SctnTtl CmplntsFdbck" style="font: 600 15px/100% 'Open Sans';color: #101010d9;padding-top: 16px;        font-weight: bold;width:18%">Electrical
                </span>
                <div class="TableHldr">
                 ...
                 <span class="SctnTtl CmplntsFdbck" style="font: 600 15px/100% 'Open Sans';color: #101010d9;padding-top: 16px;        font-weight: bold;width:18%">ELV
                 </span>
                 <div class="TableHldr">
                    <table class="AppDataTbl">
                        <tr class="Hdr">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Alarm Control</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="DataTxt">04</span></td>
                            <td>
                                <span class="DataTxt">Fire Alarm System</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">PA System</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                ...
                <div style="padding-top:25px"></div>
                 <span class="SctnTtl CmplntsFdbck" style="font: 600 15px/100% 'Open Sans';color: #101010d9;padding-top: 16px;        font-weight: bold;width:18%">Fire
                 </span>
                 <div class="TableHldr">
                    <table class="AppDataTbl">
                        <tr class="Hdr">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Extinguisher Service Report</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Extinguisher</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire Fighting</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="DataTxt">04</span></td>
                            <td>
                                <span class="DataTxt">Fire Hydrant Box</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Fire System Testing</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                ...
                <div style="padding-top:25px"></div>
                 <span class="SctnTtl CmplntsFdbck" style="font: 600 15px/100% 'Open Sans';color: #101010d9;padding-top: 16px;        font-weight: bold;width:18%">PHE
                 </span>
                 <div class="TableHldr">
                    <table class="AppDataTbl">
                        <tr class="Hdr">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Sewage Treatment Plant</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Daily Plumbing Leakage B4 Shaft</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Pump Room  JWC</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="DataTxt">04</span></td>
                            <td>
                                <span class="DataTxt">RO Plant Log Book</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Sump Pump</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Water Consumption Log</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Water Pump</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="DataTxt">Water Softner Log</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="DataTxt">09</span>
                            </td>
                            <td>
                                <span class="DataTxt">Water Tank Level Status</span>
                            </td>
                            <td>
                                <span class="DataTxt">Daily</span>
                            </td>
