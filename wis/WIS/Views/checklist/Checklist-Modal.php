...
<body>
    <div class="AppMenu">
        ...
        <ul class="MenuList">
            ...
            <li>
                <a href="LeadershipTeam.html" class="AppMenuLnk LdrshpTm">
                    <span class="LnkTxt">Leadership Team</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="Engineering.html" class="AppMenuLnk Engnrng">
                    <span class="LnkTxt">Engineering</span>
                </a>
            </li>
            <li>
                <a href="Checklist.html" class="AppMenuLnk Chcklsts Actv">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Common Area Meter Reading</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">DG Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Diesel Consumption</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Elevator Weekly</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">HT Meter</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">UPS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">CCTV Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">CCTV Monthly</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">FAS Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Alarm Control Panel</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Alarm Report</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Alarm System</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">PA System</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Extinguisher Service Report</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Extinguisher Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Extinguisher Weekly</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Fighting Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire Hydrant Box</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Fire System Testing</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Sprinkler Main Tap Off Valve</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Chiller Log Book</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">AC Unit</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">AHU</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Daily Exhaust System</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Daily Fresh Air Fan</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Daily Jet Fan</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Spilt A/C</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Ventilation Fan</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Ventilation</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <ul class="SbLnk">
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Daily Plumbing Leakage B4 Shaft</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Pump Room  JWC</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">RO Plant Log Book</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Sewage Treatment Plant</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Sump Pump</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Water Consumption Log</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Water Pump Daily</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Water Softner Log</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Water Tank Level Status</a>
                                    </li>
                                    <li>
                                        <a href="ChecklistDetails.html" class="SbLnk">Water Treatment Plant Log</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="DtlsBrdCrmb">
                                <li>
                                    <a href="Checklist.html" class="BrdCrmLnk">All Checklists</a>
                                </li>
                                <li>
                        ...
                        <div class="TableHldr">
                            <table class="AppDataTbl">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="Checklist-Modal.html" class="DataLnk DtlsArr">Detailed Report</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
