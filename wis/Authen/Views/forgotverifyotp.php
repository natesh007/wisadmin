                    ...
                    <div class="row">
                        <div class="login_wrap">
                            ...
                            <div class="login_form">
                                ...
                                <label  data-aos="fade-up" data-aos-delay="900">Sent to <?= session()->get('EmailVrfy')?><a href="<?= base_url('forgot')?>" class="resend">Resend OTP</a></label>
                                <form  action = "<?= base_url('forgotverifyotp') ?>" method="post" data-aos="fade-up" data-aos-delay="1100">
                                    <div class="form-group"> 
                                        <ul>
                                            <li><input type="text" class="form-control <?php if (session('msg')) : ?> lgerror <?php endif ?>" onkeyup="clickEvent(this,'two')" id="one" name="otp[]" maxlength="1"  ></li>
                                            <li><input type="text"class="form-control <?php if (session('msg')) : ?> lgerror <?php endif ?>" onkeyup="clickEvent(this,'three')" id="two" name="otp[]"maxlength="1" ></li>
                                            <li><input type="text"class="form-control <?php if (session('msg')) : ?> lgerror <?php endif ?>" onkeyup="clickEvent(this,'four')" id="three" name="otp[]"maxlength="1"  ></li>
                                            <li><input type="text"class="form-control <?php if (session('msg')) : ?> lgerror <?php endif ?>" id="four" name="otp[]"maxlength="1"  ></li>
                                        </ul>
                                    </div>  
                                    <?php if (session('msg')) : ?>
                                        <div class="px-5">
